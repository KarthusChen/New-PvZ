...
private:
	POINT pos_img_VS = { 0 };               // VS ???????
	POINT pos_img_tip = { 0 };              // ??????????
	POINT pos_img_1P = { 0 };               // 1P ??????
	POINT pos_img_2P = { 0 };               // 2P ??????
	POINT pos_img_1P_desc = { 0 };          // 1P ????????
	POINT pos_img_2P_desc = { 0 };          // 2P ????????
	POINT pos_img_1P_name = { 0 };          // 1P ????????
	POINT pos_img_2P_name = { 0 };          // 2P ????????
	POINT pos_animation_1P = { 0 };         // 1P ??????
	POINT pos_animation_2P = { 0 };         // 2P ??????
	POINT pos_img_1P_gravestone = { 0 };    // 1P ??????
	POINT pos_img_2P_gravestone = { 0 };    // 2P ??????
	POINT pos_1P_selector_btn_left = { 0 }; // 1P ????????
	POINT pos_1P_selector_btn_right = { 0 }; // 1P ????????
	POINT pos_2P_selector_btn_left = { 0 };  // 2P ????????
	POINT pos_2P_selector_btn_right = { 0 }; // 2P ????????
