...
public:
	...
	virtual void on_input(const ExMessage& msg)
	{
		...
		{
		case WM_KEYDOWN:
			std::cout << "[DEBUG] vkcode: " << msg.vkcode << std::endl;
			switch (id)
			{
			case PlayerID::P1:
				switch (msg.vkcode)
				...
				case 0x46:
					...
					{
						on_attack();
						std::cout << "Player::on_attack()" << std::endl;
						can_attack = false;
				...
				case 0x47:
					...
					{
						on_attack_ex();
						std::cout << "Player::on_attack_ex()" << std::endl;
						mp = 0;
					}
					break;
				}
			...
			case PlayerID::P2:
				...
				case VK_UP:
					...
					break;
				case VK_OEM_PERIOD:  // .
					std::cout << "[DEBUG] VK_OEM_PERIOD pressed" << std::endl; 
					if (can_attack)
					{
						std::cout << "[DEBUG] can_attack == true" << std::endl;
						on_attack();
						std::cout << "[DEBUG] Player::on_attack() called" << std::endl;
						can_attack = false;
						timer_attack_cd.restart();
					}
					break;
